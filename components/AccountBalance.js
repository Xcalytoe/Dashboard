                    ...
                    <div className="flex-grow md:mr-3">
                        <div className="balance__chart__buttons flex justify-between">
                            <label className={chartType === "Today" ? "balance__chart__buttons--active" : ""}>
                                <input type="radio" name="chartButton" value="Today" onChange={onChange}/>
                                <span>Today</span>
                            </label>
                            <label className={chartType === "Month" ? "balance__chart__buttons--active" : ""}>
                                <input type="radio" name="chartButton" value="Month" onChange={onChange}/>
                                <span>Month</span>
                            </label>
                            <label className={chartType === "Week" ? "balance__chart__buttons--active" : ""}>
                                <input type="radio" name="chartButton" value="Week" onChange={onChange}/>
                                <span>Week</span>
                            </label>
                            <label className={chartType === "Year" ? "balance__chart__buttons--active" : ""}>
                                <input type="radio" name="chartButton" value="Year" onChange={onChange}/>
                                <span>Year</span>
                            </label>
                        </div>
