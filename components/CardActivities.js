        ...
        <div className="card-activity__date flex items-center">
          ...
          <div className="card-activity__download flex items-center">
            <button>
              ...
              >
                <path
                  d="M17.554 7.2962C20.005 7.2962 22 9.356 22 11.8876V16.9199C22 19.4454 20.01 21.5 17.564 21.5L6.448 21.5C3.996 21.5 2 19.4413 2 16.9096V11.8773C2 9.35187 3.991 7.2962 6.438 7.2962H7.378L17.554 7.2962Z"
                  fill="#C0CCDA"
                />
                <path
